...
public class Main {
    public static void main(String[] args) {
        ...
        while (! tolyan.shipIsReady()) {
            ...
            switch (value) {
                case 10: tolyan.buildCabin(cabin);
                         System.out.println(cabin);
                         break;
                case 30: tolyan.buildEngine(engine);
                         System.out.println(engine);
                         break;
                case 50: tolyan.buildStages(stages);
                         System.out.println(stages);
                         break;
                case 66: tolyan.buildStages(stages).buildCabin(cabin).buildEngine(engine);
                         System.out.println(engine + " " + cabin + " " + stages);
                         break;
